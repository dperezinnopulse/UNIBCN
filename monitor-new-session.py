#!/usr/bin/env python3
"""
Script para monitorear la nueva sesión de Chromium
"""
...
def monitor_new_session():
    print("🔍 Monitoreando nueva sesión de Chromium\n")
    
    debug_url = "http://localhost:9225"
    ...
    try:
        ...
        print("\n✅ Monitoreo de nueva sesión completado")
        print("\n📊 Resumen:")
