# Script para probar PUT con datos mínimos
Write-Host "🔧 Probando PUT con datos mínimos..." -ForegroundColor Yellow
...
# Datos mínimos para PUT (solo campos requeridos y algunos básicos)
$putData = @{
...
Write-Host "📤 Enviando PUT request con datos mínimos..." -ForegroundColor Cyan
