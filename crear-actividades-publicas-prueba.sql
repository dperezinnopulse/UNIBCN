...
INSERT INTO Actividades (
    Titulo, Descripcion, DescripcionPrograma, FechaInicio, FechaFin, Duracion,
    CursoGratuito, LineaEstrategica, ObjetivoEstrategico, TipoActividad,
...
(
    ...
    1, 'Linea 1 - Innovacion y desarrollo tecnologico', 'Linea 1 - Innovacion y desarrollo tecnologico', 'Seminario',
...
(
    ...
    0, 'Linea 2 - Investigacion aplicada', 'Linea 2 - Investigacion aplicada', 'Master',
    'Facultad de Informatica', 19, 1, 1,
    GETDATE(), GETDATE()
);
...
(
    ...
    1, 'Linea 3 - Formacion continua', 'Linea 3 - Formacion continua', 'Taller',
...
(
    ...
    1, 'Linea 4 - Cooperacion internacional', 'Linea 4 - Cooperacion internacional', 'Conferencia',
...
(
    ...
    1, 'Linea 5 - Transferencia de conocimiento', 'Linea 5 - Transferencia de conocimiento', 'Congreso',
...
(
    ...
    0, 'Linea 1 - Innovacion y desarrollo tecnologico', 'Linea 1 - Innovacion y desarrollo tecnologico', 'Posgrado',
...
SELECT 
    a.Id, a.Titulo, a.TipoActividad, a.CursoGratuito,
