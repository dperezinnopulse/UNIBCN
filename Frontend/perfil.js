(() => {
  const baseApi = (typeof CONFIG !== 'undefined' && CONFIG && CONFIG.API_BASE_URL) ? CONFIG.API_BASE_URL : (function(){ try{ const p=location.protocol, h=location.hostname; return `${p}//${h}:5001/api`; } catch{ return 'http://localhost:5001/api'; } })();
